...
class Sharecode_AppDelegate(NSObject):
    window = IBOutlet()
    snippetController = IBOutlet()
    ...
    def applicationSupportFolder(self):
        ...
        return os.path.join(basePath, "Sharecode")
    ...
    def persistentStoreCoordinator(self):
        ...
        storePath = os.path.join(applicationSupportFolder, "Sharecode.xml")
    ...
    @IBAction
    def newAction_(self, sender):
        self.snippetController.showForWindow(self.window)
